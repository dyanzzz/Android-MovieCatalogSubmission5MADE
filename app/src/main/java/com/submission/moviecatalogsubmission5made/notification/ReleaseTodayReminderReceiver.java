package com.submission.moviecatalogsubmission5made.notification;
...
public class ReleaseTodayReminderReceiver extends BroadcastReceiver {
    ...
    private final String url = BuildConfig.BASE_URL + "movie/upcoming?api_key=" + API_KEY + "&language=en-US&page=1";
